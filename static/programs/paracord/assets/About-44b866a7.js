...
The Project will not be liable to You or anyone else for any decision made or action taken in reliance on the information given by the Service or for any consequential, special or similar damages, even if advised of the possibility of such damages.
  ...
  `}];function b(){return e(c,{children:e(i,{pad:"large",gap:"medium",width:"large",border:{color:"brand",size:"large"},background:"dark-1",round:"medium",alignSelf:"center",children:[e(r,{icon:e(l,{size:"medium"}),onClick:()=>a("/")}),e(s,{margin:"none",children:"About"}),e(t,{size:"large",color:"#FFFC00",children:["The ghost keeps your messages."," ",e("a",{href:"https://www.nytimes.com/2014/05/09/technology/snapchat-reaches-settlement-with-federal-trade-commission.html?_r=0",children:"Forever"}),"."]}),e(t,{size:"large",color:"#7289da",children:["Same goes for a certain purple..."," ",e("a",{href:"https://www.reddit.com/r/privacy/comments/jy14qi/psa_discord_lies_about_removing_deleted_files/",children:"creature"}),"."]}),e(t,{children:"So what are you supposed to do about it?"}),e(d,{items:u,children:o=>e(h,{style:{padding:"1rem 1.2rem"},title:o.title,children:e(n,{children:o.more})})})]})})}export{b as default};
